...
{
    protected $fillable = ['task_id', 'admin_id', 'chief_id', 'officer_id', 'odts_code_old', 'odts_code', 'task_name', 'admin_name', 'chief_name', 'officer_name', 'assigned_at_old', 'assigned_at', 'is_done_old', 'is_done', 'activity', 'description'];
