...
const paginationData = computed(() => props.logs);
...
const formatActivity = (activity) => {
    const map = {
        Assigned: 'Assigned',
        Notify_Done: 'Done Notify',
        Confirm_Done: 'Done Confirmation',
        Notify_Not_Done: 'Not Done Notify',
        Confirm_Not_Done: 'Not Done Confirmation',
        Cancel_Notify_Done: 'Done Notify Cancel',
        Cancel_Notify_Not_Done: 'Not Done Notify Cancel'
    }
...
let pageNumber = ref(1),
    ...
    rangeFilter = ref(usePage().props.rangeFilter ?? "today"),
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col justify-left sm:flex-row mt-6">
                    ...
                    >
                        ...
                        <option value="Notify_Done">Done Notify</option>
                        <option value="Notify_Not_Done">Not Done Notify</option>
                        <option value="Confirm_Done">Done Confirmation</option>
                        <option value="Confirm_Not_Done">Not Done Confirmation</option>
                        <option value="Cancel_Done_Notify">Done Notify Cancel</option>
                        <option value="Cancel_Not_Done_notify">Not Done Notify Cancel</option>
                    </select>
                </div>
