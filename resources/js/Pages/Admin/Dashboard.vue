...
const countAdmin = computed(() => {
    return props.admins.data.length;
});

const countChief = computed(() => {
    return props.chiefs.data.length;
});

const countOfficer = computed(() => {
    return props.officers.data.length;
});
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="mb-8 sm:flex sm:items-center justify-start">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Count of all the registered users of the system.
                        </p>
                    </div>
                </div>
                <div class="w-full mb-8 grid grid-cols-4 gap-4">
                    ...
                    <div class="bg-purple-500 text-white p-4 border-gray-300 rounded shadow flex justify-between">
                        <p>Legal Chiefs: </p>
                        <p>{{ countChief }}</p>
                    </div>
